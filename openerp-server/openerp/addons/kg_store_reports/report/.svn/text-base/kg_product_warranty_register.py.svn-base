	...
	def get_data(self,form):
		...
		self.cr.execute('''
			...
			SELECT
			  ...
			  pol.from_date as from_date,
			  pol.to_date as from_date
			  ...
			  where po.state='approved' and pol.warranty='applicable' and po.date_order >=%s and po.date_order <=%s '''+ product + partner + '''
